...
import org.example.networkintrusionmonitor.Metier.INetworkCapture;
...
public class PacketCaptureController {
    ...
    private INetworkCapture captureService;
    private PacketInfoDAO repository;
    ...
    public void setNetworkInterface(NetworkInterfaceInfo networkInterface) {
        ...
        this.captureService = new INetworkCapture();
    }
